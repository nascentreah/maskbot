...
class AmmImpl {
    ...
    getUserBalance(owner) {
        return __awaiter(this, void 0, void 0, function* () {
            const account = yield spl_token_1.Token.getAssociatedTokenAddress(token_1.ASSOCIATED_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, this.poolState.lpMint, owner, true);
            if (!account)
