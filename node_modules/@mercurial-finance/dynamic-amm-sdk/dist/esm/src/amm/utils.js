...
import { SystemProgram, SYSVAR_CLOCK_PUBKEY, TransactionInstruction, } from '@solana/web3.js';
 ...
 */
export const calculatePoolInfo = (currentTime, poolVaultALp, poolVaultBLp, vaultALpSupply, vaultBLpSupply, poolLpSupply, apyState, swapCurve, vaultA, vaultB) => {
