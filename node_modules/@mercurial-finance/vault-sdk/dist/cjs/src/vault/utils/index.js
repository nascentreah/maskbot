...
const getVaultPdas = (tokenMint, programId) => __awaiter(void 0, void 0, void 0, function* () {
    const [vault, _vaultBump] = yield web3_js_1.PublicKey.findProgramAddress([Buffer.from('vault'), tokenMint.toBuffer(), constants_1.VAULT_BASE_KEY.toBuffer()], programId);
    const [tokenVault, lpMint] = yield Promise.all([
        web3_js_1.PublicKey.findProgramAddress([Buffer.from('token_vault'), vault.toBuffer()], programId),
        web3_js_1.PublicKey.findProgramAddress([Buffer.from('lp_mint'), vault.toBuffer()], programId),
    ]);
    return {
        vaultPda: vault,
