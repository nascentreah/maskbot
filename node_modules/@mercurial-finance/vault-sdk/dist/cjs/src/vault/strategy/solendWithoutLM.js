...
const solend = __importStar(require("@mercurial-finance/solend-sdk"));
const spl_token_1 = require("@solana/spl-token");
const anchor = __importStar(require("@project-serum/anchor"));
const constants_1 = require("../constants");
class SolendWithoutLMHandler {
    ...
    withdraw(walletPubKey, program, strategy, vault, tokenVault, feeVault, lpMint, userToken, userLp, amount, preInstructions, postInstructions, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let [collateralVault] = yield web3_js_1.PublicKey.findProgramAddress([Buffer.from(constants_1.SEEDS.COLLATERAL_VAULT_PREFIX), new web3_js_1.PublicKey(strategy.pubkey).toBuffer()], program.programId);
...
exports.default = SolendWithoutLMHandler;
//# sourceMappingURL=solendWithoutLM.js.map