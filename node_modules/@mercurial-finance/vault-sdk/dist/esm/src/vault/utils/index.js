...
export const getVaultPdas = (tokenMint, programId) => __awaiter(void 0, void 0, void 0, function* () {
    const [vault, _vaultBump] = yield PublicKey.findProgramAddress([Buffer.from('vault'), tokenMint.toBuffer(), VAULT_BASE_KEY.toBuffer()], programId);
