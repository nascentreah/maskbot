...
export default class FranciumHandler {
    withdraw(walletPubKey, program, strategy, vault, tokenVault, feeVault, lpMint, userToken, userLp, amount, preInstructions, postInstructions, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lendingPool = Object.values(lendingPools).find((lendingPool) => lendingPool.lendingPoolInfoAccount.equals(new PublicKey(strategy.state.reserve)));
            if (!lendingPool)
