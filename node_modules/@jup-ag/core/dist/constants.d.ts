...
export declare const INDEXED_ROUTE_MAP_URL = "https://cache.jup.ag/indexed-route-maps-v2";
export declare const TOKEN_LIST_URL: Record<Cluster, string>;
export declare const LAMPORTS_PER_SIGNATURE = 5000;
export declare const JUPITER_FEE_OWNER: PublicKey;
...
declare type JUPITER_ERROR_TYPES = 'TransactionNotConfirmed' | 'BalancesNotExtractedProperly' | 'InsufficientSOL' | typeof IDL.errors[number]['name'];
...
export declare const FAKE_PROVIDER: AnchorProvider;
export {};
