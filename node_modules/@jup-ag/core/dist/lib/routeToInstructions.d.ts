...
declare function routeToInstructions({ user, openOrdersAddresses, userSourceTokenAccountAddress, userIntermediateTokenAccountAddresses, userDestinationTokenAccountAddress, routeInfo, platformFee, quoteMintToReferrer, asLegacyTransaction, }: RouteToInstructionsParams): Promise<{
