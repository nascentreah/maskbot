...
declare const IDL: AmmV3;

declare type AmmConfig = IdlAccounts<AmmV3>['ammConfig'];
declare type PoolState = IdlAccounts<AmmV3>['poolState'];
declare type TickArrayState = IdlAccounts<AmmV3>['tickArrayState'];
...
declare class Amm {
    ...
    static formatPoolInfo({ address, poolState, ammConfig, programId, }: {
        address: PublicKey;
        poolState: PoolState;
        ammConfig: AmmConfig;
        programId: PublicKey;
...
declare type TickArray = TickArrayState & {
    address: PublicKey;
};
declare class TickUtils {
    ...
    static mergeTickArrayBitmap(bns: BN[]): any;
...
export { Amm, AmmConfig, AmmV3, AmmV3ConfigInfo, AmmV3PoolInfo, AmmV3PoolRewardInfo, IDL, PoolState, TICK_ARRAY_BITMAP_SIZE, TICK_ARRAY_SIZE, Tick, TickArray, TickArrayState, TickUtils, getPdaTickArrayAddress };
